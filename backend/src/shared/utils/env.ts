...
const envSchema = z.object({
  ...
  ITAU_BOLETO_V1_BASE_URL: z.string().url().default('https://boleto.api.itau.com/boleto/v1'),
  ITAU_BOLETOSCASH_V2_BASE_URL: z.string().url().default('https://secure.api.cloud.itau.com.br/boletoscash/v2'),
  ITAU_EXTRATO_V1_BASE_URL: z.string().url().default('https://boleto.api.itau.com/extrato/v1'),
  ITAU_CLIENT_ID: z.string().optional(),
  ITAU_CLIENT_SECRET: z.string().optional(),
  ITAU_API_KEY: z.string().optional(),
  ITAU_ACCESS_TOKEN: z.string().optional(),
  ITAU_TIMEOUT_MS: z.coerce.number().int().positive().default(30000),
  ITAU_USE_MOCKS: booleanEnvSchema.default(true),
